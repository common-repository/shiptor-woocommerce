<script type="text/template" id="tmpl-wc-shiptor-pickpoints-map">
        ...
        <div class="wc-shiptor-jquery-modal-content">
            <section class="wc-shiptor-jquery-modal-main" role="main">
                ...
                <div class="wc-shiptor-jquery-modal-footer">
                    <div class="inner">
                        <button disabled class="wc-shiptor-jquery-save button-primary"><?php esc_html_e('Save pickpoint', 'woocommerce-shiptor') ?></button>
                    </div>
